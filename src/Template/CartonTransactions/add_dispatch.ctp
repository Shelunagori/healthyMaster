            ...
            <table>
              <tbody id="sub-body" class="hidden">
                <tr>
                    ...
                    <td><input type="text" name='cartontransaction[0][status]' class="form-control status" id="status" value="Out" readonly>
                    </td>
                    <td> <?php echo $this->Form->control('cartontransaction[0][quantity]',['class'=>'form-control quantity','id'=>false,'type'=>'number','min'=>'1','id'=>false,'label'=>false,'required']); ?></td>
