    ...
    <div class="col-md-12 col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject"><?= __('Add POP Dispatch Transaction') ?></span>
                </div>
            </div>
            ...
            <table>
              <tbody id="sub-body" class="hidden">
                <tr>
                    ...
                    <td> <?php echo $this->Form->control('poptransaction[0][quantity]',['class'=>'form-control quantity','id'=>false,'label'=>false,'required','min'=>'1']); ?></td>
