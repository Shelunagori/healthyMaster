    ...
    <div class="col-md-12 col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject"><?= __('Add To Amul') ?></span>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <?= $this->Form->control('vehicle_no', ['empty'=>'--Select--','label'=>false,'class'=>'form-control input-sm select2me','options' => $vehicles,'required']); ?>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
            ...
            <table>
              <tbody id="sub-body" class="hidden">
                <tr>
                    ...
                    <td style="vertical-align: bottom;"><?= $this->Form->control('transaction[0][party_id]', ['empty'=>'--Select--','label'=>false,'class'=>'form-control party_id input-sm' ,'options' => $parties]); ?>
                    </td>
                    ...
                    <td style="vertical-align: bottom; width: 91px;"> <button type="button" id="plus" class="btn btn-sm green"><i class="fa fa-plus"></i></button>
