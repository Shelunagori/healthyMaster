            ...
            <div class="portlet-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <?php echo $this->Form->input('vendor_id', ['empty'=>'--Select-','options'=>$vendors,'label' => false,'class' => 'form-control input-sm attribute item_id']); ?>
                    </div>
                        ...
                        <table id="main_table" class="table table-condensed table-bordered">
                            ...
                            ?>
                                <tr class="main_tr">
                                    ...
                                    <td>
                                        <?php echo $this->Form->input('purchase_booking_details['.$grn_rows.'][rate]', ['label' => false,'class' => 'form-control input-sm number cal_amount calculation_amount','placeholder'=>'Rate','value'=>$purchase_booking_detail->rate]); ?>    
                                    </td>
                                    <td>
