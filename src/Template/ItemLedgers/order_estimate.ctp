...
<div class="row">
	<div class="col-md-12">
		<div class="portlet light">
			...
			<div class="col-md-2">
						<?php echo $this->Form->control('dt',['placeholder'=>'dd-mm-yyyy','class'=>'form-control input-sm date-picker','data-date-format'=>'dd-mm-yyyy','label'=>false,'type'=>'text','value'=>date('d-m-Y')]); ?>
					</div>
					<div class="col-md-4">
			...
			<div class="portlet-body">
				<h3>
					<center>Report For Date - 
						<?php echo $dst=date('d-M-Y', strtotime($check_date)); ?>
					</center>
				</h3>
				<!-- BEGIN FORM-->
				<div class="row">
